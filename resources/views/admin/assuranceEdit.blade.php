    ...
    <div class="container h-100C">
        <div class="row justify-content-center h-100">
            <div class="col-md-8 align-self-center">
                ...
                @endif
                <div class="card">
                    <div class="card-header">{{__('Modifier une assurance')}}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('updateAssurance', ['id' => $assurance->id]) }}">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    @endphp
                                    <a href="{{(session()->get('urlP')) ? str_replace(url('/'), '', session()->get('urlP')) : '/admin/assurance/'.$assurance->id}}" class="btn btn-outline-danger">
                                        {{__('Retour')}}
                                    </a>
