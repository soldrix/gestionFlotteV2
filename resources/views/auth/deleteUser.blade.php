        ...
        <div class="row justify-content-center h-100C">
            <div class="col-md-8 d-flex align-self-center flex-column h-50">
                <div class="card bg-p shadow-block">
                    <div class="card-header bg-s">{{ __('Suppression de compte') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('deleteAccount',['id' => $user->id])}}">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                        ...
                                        <a href="{{url('/reactivate-account?email='.$user->email)}}" class="btn btn-success mx-1">Réactiver votre compte ?</a>
