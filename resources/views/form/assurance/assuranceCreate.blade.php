                ...
                <div class="card bg-p shadow-block">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('createAssurance') }}">
                            ...
                            <div class="row mb-3">
                                <label for="nom" class="col-md-4 col-form-label text-md-end">{{ __('Nom de l\'assurance ')}}<span class="text-danger">*</span>{{__(' :')}}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="frais" class="col-md-4 col-form-label text-md-end">{{ __('Frais total ')}}<span class="text-danger">*</span>{{__(' :')}}</label>
                                <div class="col-md-6">
